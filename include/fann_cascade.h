...
/* Section: FANN Cascade Training
   ...
   real network, then the most promissing of these candidate neurons is inserted inttypeo the neural network. 
...
FANN_EXTERNAL void FANN_API fann_cascadetrain_on_data(struct fann *ann,
													  ...
													  unsigned inttype max_neurons,
													  unsigned inttype neurons_between_reports,
													  float desired_error);
...
/* Function: fann_get_cascade_output_stagnation_epochs
   ...
   See also:
	...
	This function appears in FANN >= 2.0.0.
 */
FANN_EXTERNAL unsigned inttype FANN_API fann_get_cascade_output_stagnation_epochs(struct fann *ann);
...
FANN_EXTERNAL void FANN_API fann_set_cascade_output_stagnation_epochs(struct fann *ann, 
															 unsigned inttype cascade_output_stagnation_epochs);
...
/* Function: fann_get_cascade_candidate_stagnation_epochs
   ...
   See also:
	...
	This function appears in FANN >= 2.0.0.
 */
FANN_EXTERNAL unsigned inttype FANN_API fann_get_cascade_candidate_stagnation_epochs(struct fann *ann);
...
FANN_EXTERNAL void FANN_API fann_set_cascade_candidate_stagnation_epochs(struct fann *ann, 
															 unsigned inttype cascade_candidate_stagnation_epochs);
...
/* Function: fann_get_cascade_max_out_epochs
   ...
   See also:
	...
	This function appears in FANN >= 2.0.0.
 */
FANN_EXTERNAL unsigned inttype FANN_API fann_get_cascade_max_out_epochs(struct fann *ann);
...
FANN_EXTERNAL void FANN_API fann_set_cascade_max_out_epochs(struct fann *ann, 
															 unsigned inttype cascade_max_out_epochs);
 ...
 */
FANN_EXTERNAL unsigned inttype FANN_API fann_get_cascade_min_out_epochs(struct fann *ann);
...
FANN_EXTERNAL void FANN_API fann_set_cascade_min_out_epochs(struct fann *ann, 
															 unsigned inttype cascade_min_out_epochs);
...
/* Function: fann_get_cascade_max_cand_epochs
   ...
   See also:
	...
	This function appears in FANN >= 2.0.0.
 */
FANN_EXTERNAL unsigned inttype FANN_API fann_get_cascade_max_cand_epochs(struct fann *ann);
...
FANN_EXTERNAL void FANN_API fann_set_cascade_max_cand_epochs(struct fann *ann, 
															 unsigned inttype cascade_max_cand_epochs);
...
/* Function: fann_get_cascade_min_cand_epochs
   ...
   See also:
	...
	This function appears in FANN >= 2.2.0.
 */
FANN_EXTERNAL unsigned inttype FANN_API fann_get_cascade_min_cand_epochs(struct fann *ann);
...
FANN_EXTERNAL void FANN_API fann_set_cascade_min_cand_epochs(struct fann *ann, 
															 unsigned inttype cascade_min_cand_epochs);
...
/* Function: fann_get_cascade_num_candidates
   ...
   See also:
	...
	This function appears in FANN >= 2.0.0.
 */ 
FANN_EXTERNAL unsigned inttype FANN_API fann_get_cascade_num_candidates(struct fann *ann);
...
/* Function: fann_get_cascade_activation_functions_count
   ...
   See also:
	...
	This function appears in FANN >= 2.0.0.
 */
FANN_EXTERNAL unsigned inttype FANN_API fann_get_cascade_activation_functions_count(struct fann *ann);
...
/* Function: fann_get_cascade_activation_steepnesses_count
   ...
   See also:
	...
	This function appears in FANN >= 2.0.0.
 */
FANN_EXTERNAL unsigned inttype FANN_API fann_get_cascade_activation_steepnesses_count(struct fann *ann);
...
/* Function: fann_get_cascade_num_candidate_groups
   ...
   See also:
	...
	This function appears in FANN >= 2.0.0.
 */
FANN_EXTERNAL unsigned inttype FANN_API fann_get_cascade_num_candidate_groups(struct fann *ann);
...
FANN_EXTERNAL void FANN_API fann_set_cascade_num_candidate_groups(struct fann *ann, 
															 unsigned inttype cascade_num_candidate_groups);
