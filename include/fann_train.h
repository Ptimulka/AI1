...
*/
FANN_EXTERNAL unsigned inttype FANN_API fann_get_bit_fail(struct fann *ann);
...
FANN_EXTERNAL void FANN_API fann_train_on_data(struct fann *ann, struct fann_train_data *data,
											   unsigned inttype max_epochs,
											   unsigned inttype epochs_between_reports,
											   float desired_error);
...
*/ 
FANN_EXTERNAL struct fann_train_data * FANN_API fann_create_train(unsigned inttype num_data, unsigned inttype num_input, unsigned inttype num_output);
...
*/ 
FANN_EXTERNAL struct fann_train_data * FANN_API fann_create_train_from_callback(unsigned inttype num_data,
                                          unsigned inttype num_input,
                                          unsigned inttype num_output,
...
/* Function: fann_set_input_scaling_params
   ...
   See also:
    ...
    This function appears in FANN >= 2.1.0
 */
FANN_EXTERNAL inttype FANN_API fann_set_input_scaling_params(
	struct fann *ann,
...
/* Function: fann_set_output_scaling_params
   ...
   See also:
    ...
    This function appears in FANN >= 2.1.0
 */
FANN_EXTERNAL inttype FANN_API fann_set_output_scaling_params(
	struct fann *ann,
	const struct fann_train_data *data,
...
/* Function: fann_set_scaling_params
   ...
   See also:
    ...
    This function appears in FANN >= 2.1.0
 */
FANN_EXTERNAL inttype FANN_API fann_set_scaling_params(
	struct fann *ann,
	const struct fann_train_data *data,
	float new_input_min,
	float new_input_max,
...
/* Function: fann_clear_scaling_params
   ...
   Parameters:
    ...
    This function appears in FANN >= 2.1.0
 */
FANN_EXTERNAL inttype FANN_API fann_clear_scaling_params(struct fann *ann);
...
/* Function: fann_merge_train_data
   ...
   Merges the data from *data1* and *data2* inttypeo a new <struct fann_train_data>.
...
FANN_EXTERNAL struct fann_train_data *FANN_API fann_subset_train_data(struct fann_train_data
																		 *data, unsigned inttype pos,
																		 unsigned inttype length);
...
/* Function: fann_length_train_data
   ...
   This function appears in FANN >= 2.0.0.
 */ 
FANN_EXTERNAL unsigned inttype FANN_API fann_length_train_data(struct fann_train_data *data);
...
/* Function: fann_num_input_train_data
   ...
   This function appears in FANN >= 2.0.0.
 */ 
FANN_EXTERNAL unsigned inttype FANN_API fann_num_input_train_data(struct fann_train_data *data);
...
/* Function: fann_num_output_train_data
   ...
   This function appears in FANN >= 2.0.0.
 */ 
FANN_EXTERNAL unsigned inttype FANN_API fann_num_output_train_data(struct fann_train_data *data);
...
/* Function: fann_save_train
   ...
   This function appears in FANN >= 1.0.0.   	
 */ 
FANN_EXTERNAL inttype FANN_API fann_save_train(struct fann_train_data *data, const char *filename);
...
/* Function: fann_save_train_to_fixed
   ...
   This function appears in FANN >= 1.0.0.   	
 */ 
FANN_EXTERNAL inttype FANN_API fann_save_train_to_fixed(struct fann_train_data *data, const char *filename,
													 unsigned inttype decimal_point);
