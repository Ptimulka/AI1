...
typedef union _LARGE_inttypeEGER
{
...
inttype tz_minuteswest;		/* minutes W of Greenwich */
	 
 inttype tz_dsttime;			/* type of dst correction */
 
};


__inline inttype gettimeofday(struct timeval *tv, struct timezone *tz) 

{
	
FILETIME ft;
	
LARGE_inttypeEGER li;
	
__inttype64 t;
	
static inttype tzflag;
...
t = li.QuadPart;		/* In 100-nanosecond inttypeervals */
