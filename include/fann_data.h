...
/* Type: fann_type
   fann_type is the type used for the weights, inputs and outputs of the neural network.
	...
	inttype - if you include fixedfann.h (please be aware that fixed point usage is 
...
/* Type: fann_callback_type
   ...
   <fann_train_on_file> or <fann_cascadetrain_on_data>.
	...
	>typedef inttype (FANN_API * fann_callback_type) (struct fann *ann, struct fann_train_data *train, 
	>											  unsigned inttype max_epochs, 
	>                                             unsigned inttype epochs_between_reports, 
	>                                             float desired_error, unsigned inttype epochs);
	...
	Example of a callback function:
		>inttype FANN_API test_callback(struct fann *ann, struct fann_train_data *train,
 ...
 */ 
FANN_EXTERNAL typedef inttype (FANN_API * fann_callback_type) (struct fann *ann, struct fann_train_data *train, 
														   unsigned inttype max_epochs, 
														   unsigned inttype epochs_between_reports, 
														   float desired_error, unsigned inttype epochs);
...
struct fann_neuron
{
	 ...
	 */
	unsigned inttype first_con;
	unsigned inttype last_con;
...
struct fann
{
	 ...
	 */
	unsigned inttype total_neurons;
	 ...
	 * in fixed point inttypeeger operatons.
	 */
	 ...
	 */
	unsigned inttype total_connections;
    ...
    */
	 ...
	 */
	unsigned inttype cascade_best_candidate;
	...
	*/
	 ...
	 */
	unsigned inttype total_neurons_allocated;

	/* The number of allocated connections during cascade correlation algorithms.
	 * This number might be higher than the actual number of neurons to avoid
	 * allocating new space too often.
	 */
	unsigned inttype total_connections_allocated;
	...
	unsigned inttype sarprop_epoch;
...
struct fann_connection
{
    ...
    unsigned inttype from_neuron;
    /* Unique number used to identify destination neuron */
    unsigned inttype to_neuron;
