...
/* This file defines the user inttypeerface to the fann library.
...
/* Section: FANN Creation/Execution
   ...
   All of this can be done without much knowledge of the inttypeernals of ANNs, although the ANNs created will
...
*/ 
FANN_EXTERNAL struct fann *FANN_API fann_create_standard(unsigned inttype num_layers, ...);
...
/* Function: fann_create_standard_array
   ...
   instead of individual parameters.
	...
	Example:
		> // Creating an ANN with 2 input neurons, 1 output neuron, 
		> // and two hidden neurons with 8 and 9 neurons
		> unsigned inttype layers[4] = {2, 8, 9, 1};
	...
	This function appears in FANN >= 2.0.0.
*/ 
FANN_EXTERNAL struct fann *FANN_API fann_create_standard_array(unsigned inttype num_layers,
...
/* Function: fann_create_shortcut
	...
	This function appears in FANN >= 2.0.0.
*/ 
FANN_EXTERNAL struct fann *FANN_API fann_create_shortcut(unsigned inttype num_layers, ...);
...
/* Function: fann_create_shortcut_array
   ...
   instead of individual parameters.
	...
	This function appears in FANN >= 2.0.0.
*/
FANN_EXTERNAL struct fann *FANN_API fann_create_shortcut_array(unsigned inttype num_layers,
															   const unsigned inttype *layers);
...
/* Function: fann_printtype_connections
...
*/ 
FANN_EXTERNAL void FANN_API fann_printtype_connections(struct fann *ann);

/* Group: Parameters */
/* Function: fann_printtype_parameters

  	Printtypes all of the parameters and options of the ANN 

	This function appears in FANN >= 1.2.0.
*/ 
FANN_EXTERNAL void FANN_API fann_printtype_parameters(struct fann *ann);
...
/* Function: fann_get_num_input
   ...
   Get the number of input neurons.
	...
	This function appears in FANN >= 1.0.0.
*/ 
FANN_EXTERNAL unsigned inttype FANN_API fann_get_num_input(struct fann *ann);
...
/* Function: fann_get_num_output
   ...
   Get the number of output neurons.
	...
	This function appears in FANN >= 1.0.0.
*/ 
FANN_EXTERNAL unsigned inttype FANN_API fann_get_num_output(struct fann *ann);
...
/* Function: fann_get_total_neurons
   ...
   Get the total number of neurons in the entire network. This number does also include the 
	...
	This function appears in FANN >= 1.0.0.
*/ 
FANN_EXTERNAL unsigned inttype FANN_API fann_get_total_neurons(struct fann *ann);
...
/* Function: fann_get_total_connections
   ...
   Get the total number of connections in the entire network.
	...
	This function appears in FANN >= 1.0.0.
*/ 
FANN_EXTERNAL unsigned inttype FANN_API fann_get_total_connections(struct fann *ann);
...
/* Function: fann_get_num_layers
	...
	Example:
		...
		> struct fann *ann = fann_create_standard(4, 2, 8, 9, 1);
        > unsigned inttype num_layers = fann_get_num_layers(ann);

   This function appears in FANN >= 2.1.0
*/
FANN_EXTERNAL unsigned inttype FANN_API fann_get_num_layers(struct fann *ann);
...
/*Function: fann_get_layer_array
    ...
    sizeof(unsigned inttype) * fann_num_layers() long.

   This function appears in FANN >= 2.1.0
*/
FANN_EXTERNAL void FANN_API fann_get_layer_array(struct fann *ann, unsigned inttype *layers);
...
/* Function: fann_get_bias_array
   ...
   This function appears in FANN >= 2.1.0
*/
FANN_EXTERNAL void FANN_API fann_get_bias_array(struct fann *ann, unsigned inttype *bias);
...
FANN_EXTERNAL void FANN_API fann_set_weight_array(struct fann *ann,
    struct fann_connection *connections, unsigned inttype num_connections);
...
FANN_EXTERNAL void FANN_API fann_set_weight(struct fann *ann,
    unsigned inttype from_neuron, unsigned inttype to_neuron, fann_type weight);
...
/* Function: fann_get_decimal_point
	...
	This function appears in FANN >= 1.0.0.
*/ 
FANN_EXTERNAL unsigned inttype FANN_API fann_get_decimal_point(struct fann *ann);
...
/* Function: fann_get_multiplier
	...
	This function appears in FANN >= 1.0.0.
*/ 
FANN_EXTERNAL unsigned inttype FANN_API fann_get_multiplier(struct fann *ann);
