...
/* Function: fann_save
   ...
   This function appears in FANN >= 1.0.0.
 */
FANN_EXTERNAL inttype FANN_API fann_save(struct fann *ann, const char *configuration_file);
...
/* Function: fann_save_to_fixed
   ...
   This function appears in FANN >= 1.0.0.
*/ 
FANN_EXTERNAL inttype FANN_API fann_save_to_fixed(struct fann *ann, const char *configuration_file);
