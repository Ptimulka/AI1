...
inttype fann_save_internal(struct fann *ann, const char *configuration_file,
					   unsigned inttype save_as_fixed);
inttype fann_save_internal_fd(struct fann *ann, FILE * conf, const char *configuration_file,
						  unsigned inttype save_as_fixed);
inttype fann_save_train_internal(struct fann_train_data *data, const char *filename,
							  unsigned inttype save_as_fixed, unsigned inttype decimal_point);
inttype fann_save_train_internal_fd(struct fann_train_data *data, FILE * file, const char *filename,
								 unsigned inttype save_as_fixed, unsigned inttype decimal_point);
