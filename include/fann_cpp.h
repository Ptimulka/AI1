...
public:
	...
	*/
	void copy_from_struct_fann(struct fann* other)
	{
        ...
        */ 
        ...
        /* Method: printtype_connections
	        ...
	        Will printtype the connections of the ann in a compact matrix, for easy viewing of the internals 
	        of the ann.
    ...
    private:
        ...
        static inttype FANN_API internal_callback(struct fann *ann, struct fann_train_data *train, 
