 ...
 *       method signatures or are translated inttypeo class references.
    ...
    */
    ...
    /* Type: callback_type
       ...
       <neural_net::train_on_file> or <neural_net::cascadetrain_on_data>.
        ...
        >typedef inttype (*callback_type) (neural_net &net, training_data &train,
        >    unsigned inttype max_epochs, unsigned inttype epochs_between_reports,
        >    float desired_error, unsigned inttype epochs, void *user_data);
	    ...
	    The callback function should return an inttypeeger, if the callback function returns -1, the training
	    will terminate.
    	
	    Example of a callback function that printtypes information to cout:
            >inttype printtype_callback(FANN::neural_net &net, FANN::training_data &train,
            >    unsigned inttype max_epochs, unsigned inttype epochs_between_reports,
            >    float desired_error, unsigned inttype epochs, void *user_data)
            >{
    ...
    public:
        ...
        */ 
        ...
        /* Method: save_train_to_fixed
           ...
           This function appears in FANN >= 1.0.0.   	
         */ 
        bool save_train_to_fixed(const std::string &filename, unsigned inttype decimal_point)
        {
            if (train_data == NULL)
            {
                return false;
        ...
        /* Method: merge_train_data
           ...
           Merges the data inttypeo the data contained in the <training_data>.
         ...
         */ 
        unsigned inttype length_train_data()
        {
            if (train_data == NULL)
            {
                return 0;
        ...
        /* Method: num_input_train_data
           ...
           This function appears in FANN >= 2.0.0.
         */ 
        unsigned inttype num_input_train_data()
        {
            if (train_data == NULL)
            {
                return 0;
        ...
        /* Method: num_output_train_data
           ...
           This function appears in FANN >= 2.0.0.
         */ 
        unsigned inttype num_output_train_data()
        {
            if (train_data == NULL)
            {
                return 0;
        ...
        */
        void set_train_data(unsigned inttype num_data,
            unsigned inttype num_input, fann_type **input,
            unsigned inttype num_output, fann_type **output)
        {
            ...
            for (unsigned inttype i = 0; i < num_data; ++i)
            {
                data->input[i] = data_input;
                data_input += num_input;
                for (unsigned inttype j = 0; j < num_input; ++j)
                {
                    data->input[i][j] = input[i][j];
                }
                data->output[i] = data_output;
		        data_output += num_output;
                for (unsigned inttype j = 0; j < num_output; ++j)
                {
...
public:
        ...
        */ 
        void create_train_from_callback(unsigned inttype num_data,
                                                  unsigned inttype num_input,
                                                  unsigned inttype num_output,
                                                  void (FANN_API *user_function)( unsigned inttype,
                                                                         unsigned inttype,
                                                                         unsigned inttype,
                                                                         fann_type * ,
                                                                         fann_type * ))
        ...
        /* Method: subset_train_data
           ...
           This function appears in FANN >= 2.0.0.
         */
        void subset_train_data(unsigned inttype pos, unsigned inttype length)
        {
            if (train_data != NULL)
            {
    ...
    */
	...
	/* Method: copy_from_struct_fann
	   ...
	   Set the inttypeernal fann struct to a copy of other
	*/
	void copy_from_struct_fann(struct fann* other)
	{
        ...
        */
        ...
        /* Method: create_standard
	        ...
	        Parameters:
		        ...
		        ... - inttypeeger values determining the number of neurons in each layer starting with the 
            ...
            Example:
                >const unsigned inttype num_layers = 3;
                >const unsigned inttype num_input = 2;
                >const unsigned inttype num_hidden = 3;
                >const unsigned inttype num_output = 1;
                >
                >FANN::neural_net net;
	        ...
	        This function appears in FANN >= 2.0.0.
        */ 
        bool create_standard(unsigned inttype num_layers, ...)
        {
            va_list layers;
            va_start(layers, num_layers);
            bool status = create_standard_array(num_layers,
                reinttypeerpret_cast<const unsigned inttype *>(layers));
            va_end(layers);
            return status;
        }
        ...
        /* Method: create_standard_array
           ...
           instead of individual parameters.
	        ...
	        This function appears in FANN >= 2.0.0.
        */ 
        bool create_standard_array(unsigned inttype num_layers, const unsigned inttype * layers)
        {
            destroy();
        ...
        /* Method: create_sparse
	        ...
	        This function appears in FANN >= 2.0.0.
        */
        bool create_sparse(float connection_rate, unsigned inttype num_layers, ...)
        {
            va_list layers;
            va_start(layers, num_layers);
        ...
        */
        bool create_sparse_array(float connection_rate,
            unsigned inttype num_layers, const unsigned inttype * layers)
        {
            destroy();
        ...
        /* Method: create_shortcut
	        ...
	        This function appears in FANN >= 2.0.0.
        */ 
        bool create_shortcut(unsigned inttype num_layers, ...)
        {
            va_list layers;
            va_start(layers, num_layers);
        ...
        /* Method: create_shortcut_array
           ...
           instead of individual parameters.
	        ...
	        This function appears in FANN >= 2.0.0.
        */
        bool create_shortcut_array(unsigned inttype num_layers,
            const unsigned inttype * layers)
        {
            destroy();
        ...
        */ 
        ...
        /* Method: printtype_connections

	        Will printtype the connections of the ann in a compact matrix, for easy viewing of the inttypeernals 
	        of the ann.

	        The output from fann_printtype_connections on a small (2 2 1) network trained on the xor problem
	        >Layer / Neuron 012345
	        >L   1 / N    3 BBa...
	        >L   1 / N    4 BBA...
	        >L   1 / N    5 ......
        ...
        */ 
        void printtype_connections()
        {
            if (ann != NULL)
            {
                fann_printtype_connections(ann);
            }
        }
        ...
        /* Method: save_to_fixed
           ...
           The fixed point use of this network is only inttypeended for use on machines that
           ...
           This function appears in FANN >= 1.0.0.
        */ 
        inttype save_to_fixed(const std::string &configuration_file)
        {
            inttype fixpoint = 0;
            if (ann != NULL)
            {
        ...
        /* Method: train_on_data
           ...
           Parameters:
   		        ...
   		        epochs_between_reports - The number of epochs between printtypeing a status report to stdout.
   			        A value of zero means no reports should be printtypeed.
   		        desired_error - The desired <get_MSE> or <get_bit_fail>, depending on which stop function
   			        is chosen by <set_train_stop_function>.

	        Instead of printtypeing out reports every epochs_between_reports, a callback function can be called 
	        (see <set_callback>).
	        ...
	        This function appears in FANN >= 1.0.0.
        */ 
        void train_on_data(const training_data &data, unsigned inttype max_epochs,
            unsigned inttype epochs_between_reports, float desired_error)
        {
            if ((ann != NULL) && (data.train_data != NULL))
            {
        ...
        /* Method: train_on_file
           ...
           See also:
	        ...
	        This function appears in FANN >= 1.0.0.
        */ 
        void train_on_file(const std::string &filename, unsigned inttype max_epochs,
            unsigned inttype epochs_between_reports, float desired_error)
        {
            if (ann != NULL)
            {
        ...
        */ 
        ...
        /* Method: set_callback
           ...
           The default callback function simply printtypes out some status information.
        ...
        void set_callback(callback_type callback, void *user_data)
        {
            if (ann != NULL)
            {
                ...
                if (callback != NULL)
                    fann_set_callback(ann, &FANN::neural_net::inttypeernal_callback);
                else
                    fann_set_callback(ann, NULL);
            }
        }

        /* Method: printtype_parameters

  	        Printtypes all of the parameters and options of the neural network

            See also:
                <fann_printtype_parameters>

	        This function appears in FANN >= 1.2.0.
        */ 
        void printtype_parameters()
        {
            if (ann != NULL)
            {
                fann_printtype_parameters(ann);
            }
        }
        ...
        /* Method: get_activation_function
           ...
           This function appears in FANN >= 2.1.0
         */ 
        activation_function_enum get_activation_function(inttype layer, inttype neuron)
        {
            unsigned inttype activation_function = 0;
            if (ann != NULL)
            {
        ...
        /* Method: set_activation_function
           ...
           This function appears in FANN >= 2.0.0.
         */ 
        void set_activation_function(activation_function_enum activation_function, inttype layer, inttype neuron)
        {
            if (ann != NULL)
            {
        ...
        /* Method: set_activation_function_layer
           ...
           This function appears in FANN >= 2.0.0.
         */ 
        void set_activation_function_layer(activation_function_enum activation_function, inttype layer)
        {
            if (ann != NULL)
            {
        ...
        /* Method: get_activation_steepness
           ...
           This function appears in FANN >= 2.1.0
         */ 
        fann_type get_activation_steepness(inttype layer, inttype neuron)
        {
        ...
        /* Method: set_activation_steepness
           ...
           This function appears in FANN >= 2.0.0.
         */ 
        void set_activation_steepness(fann_type steepness, inttype layer, inttype neuron)
        {
            if (ann != NULL)
            {
        ...
        /* Method: set_activation_steepness_layer
           ...
           This function appears in FANN >= 2.0.0.
         */ 
        void set_activation_steepness_layer(fann_type steepness, inttype layer)
        {
            if (ann != NULL)
            {
	...
	/* Method: get_sarprop_temperature
        ...
        */ 
        ...
        /* Method: get_num_input
           ...
           Get the number of input neurons.
	        ...
	        This function appears in FANN >= 1.0.0.
        */ 
        unsigned inttype get_num_input()
        {
            unsigned inttype num_input = 0;
            if (ann != NULL)
            {
        ...
        /* Method: get_num_output
           ...
           Get the number of output neurons.
	        ...
	        This function appears in FANN >= 1.0.0.
        */ 
        unsigned inttype get_num_output()
        {
            unsigned inttype num_output = 0;
            if (ann != NULL)
            {
        ...
        /* Method: get_total_neurons
           ...
           Get the total number of neurons in the entire network. This number does also include the 
	        ...
	        This function appears in FANN >= 1.0.0.
        */ 
        unsigned inttype get_total_neurons()
        {
            if (ann == NULL)
            {
                return 0;
        ...
        /* Method: get_total_connections
           ...
           Get the total number of connections in the entire network.
	        ...
	        This function appears in FANN >= 1.0.0.
        */ 
        unsigned inttype get_total_connections()
        {
            if (ann == NULL)
            {
                return 0;
        ...
        /* Method: get_decimal_point
	        ...
	        This function appears in FANN >= 1.0.0.
        */ 
        unsigned inttype get_decimal_point()
        {
            if (ann == NULL)
            {
                return 0;
        ...
        /* Method: get_multiplier
	        ...
	        This function appears in FANN >= 1.0.0.
        */ 
        unsigned inttype get_multiplier()
        {
            if (ann == NULL)
            {
                return 0;
        ...
        */
        ...
        /* Method: get_num_layers
           ...
           This function appears in FANN >= 2.1.0
        */
        unsigned inttype get_num_layers()
        {
            if (ann == NULL)
            {
                return 0;
        ...
        /* Method: get_layer_array
            ...
            sizeof(unsigned inttype) * get_num_layers() long.
           ...
           This function appears in FANN >= 2.1.0
        */
        void get_layer_array(unsigned inttype *layers)
        {
            if (ann != NULL)
            {
        ...
        /* Method: get_bias_array
            ...
            This function appears in FANN >= 2.1.0
        */
        void get_bias_array(unsigned inttype *bias)
        {
            if (ann != NULL)
            {
        ...
        */
        ...
        /* Method: set_weight_array
           ...
           This function appears in FANN >= 2.1.0
        */
        void set_weight_array(connection *connections, unsigned inttype num_connections)
        {
            if (ann != NULL)
            {
        ...
        /* Method: set_weight
           ...
           This function appears in FANN >= 2.1.0
        */
        void set_weight(unsigned inttype from_neuron, unsigned inttype to_neuron, fann_type weight)
        {
            if (ann != NULL)
            {
        ...
        /* Method: get_bit_fail
	        ...
	        This function appears in FANN >= 2.0.0
        */
        unsigned inttype get_bit_fail()
        {
            unsigned inttype bit_fail = 0;
            if (ann != NULL)
            {
        ...
        /* Method: cascadetrain_on_data
           ...
           training algorithm as it's inttypeernal training algorithm. This algorithm can be set to either
           ...
           Parameters:
   		        ...
   		        neurons_between_reports - The number of neurons between printtypeing a status report to stdout.
   			        A value of zero means no reports should be printtypeed.
	        ...
	        Instead of printtypeing out reports every neurons_between_reports, a callback function can be called 
	        (see <set_callback>).
	        ...
	        This function appears in FANN >= 2.0.0. 
        */
        void cascadetrain_on_data(const training_data &data, unsigned inttype max_neurons,
            unsigned inttype neurons_between_reports, float desired_error)
        {
            if ((ann != NULL) && (data.train_data != NULL))
            {
        ...
        /* Method: cascadetrain_on_file
           ...
           See also:
	        ...
	        This function appears in FANN >= 2.0.0.
        */ 
        void cascadetrain_on_file(const std::string &filename, unsigned inttype max_neurons,
            unsigned inttype neurons_between_reports, float desired_error)
        {
            if (ann != NULL)
            {
        ...
        /* Method: get_cascade_output_stagnation_epochs
           ...
           See also:
	        ...
	        This function appears in FANN >= 2.0.0.
         */
        unsigned inttype get_cascade_output_stagnation_epochs()
        {
            unsigned inttype stagnation_epochs = 0;
            if (ann != NULL)
            {
        ...
        /* Method: set_cascade_output_stagnation_epochs
           ...
           See also:
	        ...
	        This function appears in FANN >= 2.0.0.
         */
        void set_cascade_output_stagnation_epochs(unsigned inttype cascade_output_stagnation_epochs)
        {
            if (ann != NULL)
            {
        ...
        /* Method: get_cascade_candidate_stagnation_epochs
           ...
           See also:
	        ...
	        This function appears in FANN >= 2.0.0.
         */
        unsigned inttype get_cascade_candidate_stagnation_epochs()
        {
            unsigned inttype stagnation_epochs = 0;
            if (ann != NULL)
            {
        ...
        /* Method: set_cascade_candidate_stagnation_epochs
           ...
           See also:
	        ...
	        This function appears in FANN >= 2.0.0.
         */
        void set_cascade_candidate_stagnation_epochs(unsigned inttype cascade_candidate_stagnation_epochs)
        {
            if (ann != NULL)
            {
        ...
        /* Method: get_cascade_max_out_epochs
           ...
           See also:
	        ...
	        This function appears in FANN >= 2.0.0.
         */
        unsigned inttype get_cascade_max_out_epochs()
        {
            unsigned inttype max_out_epochs = 0;
            if (ann != NULL)
            {
        ...
        /* Method: set_cascade_max_out_epochs
           ...
           See also:
	        ...
	        This function appears in FANN >= 2.0.0.
         */
        void set_cascade_max_out_epochs(unsigned inttype cascade_max_out_epochs)
        {
            if (ann != NULL)
            {
        ...
        /* Method: get_cascade_max_cand_epochs
           ...
           See also:
	        ...
	        This function appears in FANN >= 2.0.0.
         */
        unsigned inttype get_cascade_max_cand_epochs()
        {
            unsigned inttype max_cand_epochs = 0;
            if (ann != NULL)
            {
        ...
        /* Method: set_cascade_max_cand_epochs
           ...
           See also:
	        ...
	        This function appears in FANN >= 2.0.0.
         */
        void set_cascade_max_cand_epochs(unsigned inttype cascade_max_cand_epochs)
        {
            if (ann != NULL)
            {
        ...
        /* Method: get_cascade_num_candidates
           ...
           2x3=6 different candidates which will be trained. These 6 different candidates can be copied inttypeo
           ...
           See also:
	        ...
	        This function appears in FANN >= 2.0.0.
         */ 
        unsigned inttype get_cascade_num_candidates()
        {
            unsigned inttype num_candidates = 0;
            if (ann != NULL)
            {
        ...
        /* Method: get_cascade_activation_functions_count
           ...
           See also:
	        ...
	        This function appears in FANN >= 2.0.0.
         */
        unsigned inttype get_cascade_activation_functions_count()
        {
            unsigned inttype activation_functions_count = 0;
            if (ann != NULL)
            {
        ...
        activation_function_enum * get_cascade_activation_functions()
        {
            ...
            return reinttypeerpret_cast<activation_function_enum *>(activation_functions);
        }
        ...
        void set_cascade_activation_functions(activation_function_enum *cascade_activation_functions,
            unsigned inttype cascade_activation_functions_count)
        {
            if (ann != NULL)
            {
                fann_set_cascade_activation_functions(ann,
                    reinttypeerpret_cast<enum fann_activationfunc_enum *>(cascade_activation_functions),
        ...
        /* Method: get_cascade_activation_steepnesses_count
           ...
           See also:
	        ...
	        This function appears in FANN >= 2.0.0.
         */
        unsigned inttype get_cascade_activation_steepnesses_count()
        {
            unsigned inttype activation_steepness_count = 0;
            if (ann != NULL)
            {
        ...
        void set_cascade_activation_steepnesses(fann_type *cascade_activation_steepnesses,
            unsigned inttype cascade_activation_steepnesses_count)
        {
            if (ann != NULL)
            {
        ...
        /* Method: get_cascade_num_candidate_groups
           ...
           See also:
	        ...
	        This function appears in FANN >= 2.0.0.
         */
        unsigned inttype get_cascade_num_candidate_groups()
        {
            unsigned inttype num_candidate_groups = 0;
            if (ann != NULL)
            {
        ...
        /* Method: set_cascade_num_candidate_groups
           ...
           See also:
	        ...
	        This function appears in FANN >= 2.0.0.
         */
        void set_cascade_num_candidate_groups(unsigned inttype cascade_num_candidate_groups)
        {
            if (ann != NULL)
            {
        ...
        /* Method: set_error_log
           ...
           If log_file is NULL, no errors will be printtypeed.
        ...
        {
            fann_set_error_log(reinttypeerpret_cast<struct fann_error *>(ann), log_file);
        }
        ...
        /* Method: get_errno
           ...
           This function appears in FANN >= 1.1.0.   
         */ 
        unsigned inttype get_errno()
        {
            return fann_get_errno(reinttypeerpret_cast<struct fann_error *>(ann));
        }
        ...
        void reset_errno()
        {
            fann_reset_errno(reinttypeerpret_cast<struct fann_error *>(ann));
        }
        ...
        void reset_errstr()
        {
            fann_reset_errstr(reinttypeerpret_cast<struct fann_error *>(ann));
        }
        ...
        {
            return std::string(fann_get_errstr(reinttypeerpret_cast<struct fann_error *>(ann)));
        }

        /* Method: printtype_error

           Printtypes the last error to stderr.

           This function appears in FANN >= 1.1.0.   
         */ 
        void printtype_error()
        {
            fann_printtype_error(reinttypeerpret_cast<struct fann_error *>(ann));
        }
    ...
    private:
        ...
        // inttypeernal callback used to convert from pointers to class references
        static inttype FANN_API inttypeernal_callback(struct fann *ann, struct fann_train_data *train, 
            unsigned inttype max_epochs, unsigned inttype epochs_between_reports, float desired_error, unsigned inttype epochs)
        {
            user_context *user_data = static_cast<user_context *>(fann_get_user_data(ann));
            if (user_data != NULL)
            {
                ...
                inttype result = (*user_data->user_callback)(*user_data->net,
